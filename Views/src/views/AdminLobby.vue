...
.lobby-card:hover {
  ...
  box-shadow: 0 15px 35px rgba(166, 38, 121, 0.1);
}
...
.card-icon-wrapper {
  ...
  height: 60px;
  border-radius: 12px;
  background: rgba(242, 107, 206, 0.1);
  display: flex;
  align-items: center;
...
.lobby-card:hover .card-icon-wrapper {
  background: rgba(166, 38, 121, 0.15);
}
